...
ContentPage {
    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            ConfigSpinBox {
                ...
                tooltip: Translation.tr("-1.0 to 1.0, 0 is no change")
            ...
            ConfigSpinBox {
                ...
                tooltip: Translation.tr("0 = none, 1 = flat, 2 = adaptive")
        ...
        ConfigSpinBox {
            icon: "scroll"
            text: Translation.tr("Scroll factor (multiplier)")
        ...
        ConfigSwitch {
            ...
            checked: HyprlandConfig.get("input:touchpad:natural_scroll") !== "false"
    ...
    ContentSection {
        ...
        ConfigSwitch {
            ...
            tooltip: Translation.tr("1-finger left, 2-finger right, 3-finger middle")
